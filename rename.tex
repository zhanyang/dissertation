...
Range-rename can perform tree surgery to create a subtree of \spre and move the
subtree to the location of \dpre in the \bet.
The next goal of range-rename is to update prefixes of keys in the subtree.
...
simply \textbf{lifting} for short~\ref{fig:lift}.
