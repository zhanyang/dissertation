...
\begin{figure}
    ...
    \node[anchor=south, rectangle, rounded corners, text centered, minimum height=.05\textwidth, minimum width=.5\textwidth, draw=black, fill=green!50] at (0, .64\textwidth) {application};
