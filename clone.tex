...
message into the root of the tree,
\delold is set to false in the section.

One simple implementation of range-clone can utilize the range-rename code,
while making both the parents of LCAs have the source LCA as a child and
discarding the destination subtree.
This implementation turns the lifted a \bet to a lifted \bedag.
...
\subsection{From a \bet to a \bedag}
