...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \caption{\label{subfig:goto-3} The range-clone generates a \goto message
...
source LCA.
\item Then it injects a \goto message to the root of the lifted \bedag with the
source LCA as the node ID in the \goto message.
