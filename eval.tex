...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Sequential-write and sequential-read benchmark on empty file systems]{\label{fig:seq_io_empty}Bandwidth to sequentially read and write a 10 GiB file on empty file systems (higher is better).}
\end{figure}
...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Sequential-write and sequential-read benchmark on aged file systems]{\label{fig:seq_io_aged}Bandwidth to sequentially read and write a 10 GiB file on aged file systems (higher is better).}
\end{figure}
...
Figure~\ref{fig:toku_aged} shows the results of running Tokubench on aged
file systems.
...
Figure~\ref{fig:file_rename_aged} shows the results of running the benchmark
...
Figure~\ref{fig:git_aged} shows the results of running the benchmark on aged
file systems.
All versions of \betrfs become slightly slower, because the \bets are taller.
However,
\betrfsFive is faster than any other file systems,
because, in the aged setting, the other file systems cannot allocate spaces that
...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Tar benchmark on empty file systems]{\label{fig:tar_empty}
        Latency to untar and tar the Liinux-3.11.10 source directory on empty file systems (lower is better).}
\end{figure}
...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Tar benchmark on aged file systems]{\label{fig:tar_aged}
        Latency to untar and tar the Liinux-3.11.10 source directory on aged file systems (lower is better).}
\end{figure}
...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Rsync benchmark on empty file system]{\label{fig:rsync_empty}
        Throughput of cloning the Linux-3.11.10 source directory with rsync on empty file systems (higher is better).}
\end{figure}
...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Rsync benchmark on aged file system]{\label{fig:rsync_aged}
        Throughput of cloning the Linux-3.11.10 source directory with rsync on aged file systems (higher is better).}
\end{figure}
...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Mailserver benchmarki on empty file systems]{\label{fig:imap_empty}
        Throughput of the dovecot mailserver on empty file systems (higher is better).}
\end{figure}
...
\begin{figure}[t]
    ...
    \begin{tikzpicture}[yscale=0.95, xscale=0.95]
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Mailserver benchmarki on aged file systems]{\label{fig:imap_aged}
        Throughput of the dovecot mailserver on aged file systems (higher is better).}
\end{figure}
