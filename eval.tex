    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{tikzpicture}[yscale=0.95, xscale=0.95]
            \begin{axis}[
                    ...
                    ylabel={Throughput (renames per second)},
                    xmin=12,
                    xmax=26,
...
file systems.
In this case, we clone the git repository under the directory that contains the
aged git repository.
...
file systems.
In this case, the benchmark copies the tar ball under the aged git repository
and performs untar and tar there.
...
aged file systems.
In this case, the benchmark is performed under the aged git repository.
