...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{tikzpicture}[xscale=0.95, yscale=0.95]
            ...
            \node[anchor=south, font=\tiny] at  (-.0325\textwidth, .041\textwidth) {PUT(z,...)};
            \node[anchor=south, rectangle, minimum height=.015\textwidth, minimum width=.1\textwidth, draw=black] at (-.0325\textwidth, .027\textwidth) {};
            \node[anchor=south, font=\tiny] at  (-.0325\textwidth, .021\textwidth) {DEL(o)};
...
With the sharing broken, the \bedag can flush message PUT(``/B/b'',...) from
