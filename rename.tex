...
An invariant the \bet inherits from the \btree is that all leaf nodes should be
at the same distance from the root node.
Otherwise, the \bet or \btree is unbalanced, breaking the asymptotic I/O cost
analysis.
