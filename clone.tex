...
The \bedag breaks the sharing of a node using Copy-on-Write.
...
In order to track the sharing status of nodes, the \bedag maintains reference
counting for each node.
